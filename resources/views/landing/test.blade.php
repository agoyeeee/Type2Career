...
<!-- Main Content -->
<div class="container text-center max-w-3xl mt-20">
    ...
    <p class="text-lg leading-relaxed text-gray-400 mb-10">
        Selamat datang di tes MBTI (Myers-Briggs Type Indicator) kami! Tes ini dirancang untuk membantu Anda memahami
        tipe kepribadian Anda dengan lebih baik, sehingga Anda dapat menemukan jalur karier yang paling sesuai dengan
        kekuatan dan preferensi pribadi Anda.
    </p>

    <!-- Info Box -->
    <div class="bg-gray-900 border border-gray-700 rounded-lg p-5 max-w-2xl text-left text-gray-300 mb-5 mt-60 ">
        <div class="space-y-4">
            <h2 class="text-2xl font-bold text-white mb-2">How does this test work?</h2>
            <p class="text-base text-gray-400">
                Tes MBTI terdiri dari serangkaian pertanyaan yang mengeksplorasi cara Anda berpikir, membuat keputusan,
                dan berinteraksi dengan dunia di sekitar Anda. Berdasarkan jawaban Anda, kami akan mengidentifikasi tipe
            ...
            <p class="text-base text-gray-400">
                ...
                Anda.<br>
                3. Terima Rekomendasi Karier – Berdasarkan hasil MBTI Anda, kami akan merekomendasikan jalur karier yang
                sesuai dengan kepribadian dan preferensi Anda.
            </p>
            <p class="text-base text-gray-400">
                <strong class="text-white">Why is this test important?</strong><br>
                Memahami kepribadian Anda adalah langkah pertama dalam merencanakan masa depan karier yang sukses. Tes

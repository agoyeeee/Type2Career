...
@section('content')
  ...
  <!-- Main Content -->
  <div class="container text-center max-w-3xl mt-8">
    <h1 class="text-4xl font-bold uppercase mb-5">Take the <span class="text-blue-500">MBTI</span> Test</h1>
    ...
    <!-- Info Box -->
    <div class="bg-gray-900 border border-gray-700 rounded-lg p-5 max-w-2xl text-left text-gray-300 mb-5">
      <div class="space-y-4">
    ...
    <a href="#" class="inline-block px-6 py-3 text-lg font-bold text-white bg-purple-700 rounded-lg hover:bg-purple-500 transition duration-300 mt-5">
      Mulai
    </a>
  </div>
</body>
